SELECT 
    ...
    SUM(CASE WHEN (yd.region_name = '西南' AND yd.category = '中国备件区成本') OR (yd.region_name != '西南' AND yd.category = '备件成本') AND yd.years = '2025' THEN yd.total_cost ELSE 0 END) AS cumulative_spare_parts_cost,
    ...
    SUM(CASE WHEN (yd.region_name = '西南' AND yd.category = '中国备件区成本') OR (yd.region_name != '西南' AND yd.category = '备件成本') AND yd.years = '2025' THEN yd.total_cost ELSE 0 END) - SUM(CASE WHEN (yd.region_name = '西南' AND yd.category = '中国备件区成本') OR (yd.region_name != '西南' AND yd.category = '备件成本') AND yd.years = '2024' THEN yd.total_cost ELSE 0 END) AS spare_parts_cost_year_on_year,
